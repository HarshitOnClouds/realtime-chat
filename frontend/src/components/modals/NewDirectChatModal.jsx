    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white bg-opacity-10 backdrop-blur-lg p-6 rounded-2xl w-96 border border-white border-opacity-20">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold text-white">Start Direct Chat</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-white text-sm mb-2">User Email</label>
            <input
              type="email"
        ...
        <div className="mt-4 p-3 bg-white bg-opacity-5 rounded-lg">
          <p className="text-white text-opacity-60 text-sm">
            💡 Enter the email address of a registered user to start a direct conversation.
          </p>
        </div>
      </div>
    </div>
